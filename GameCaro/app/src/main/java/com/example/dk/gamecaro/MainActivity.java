package com.example.dk.gamecaro;
...
public class MainActivity extends Activity {
    ...
    private void setListen() {
        ...
        tvTurn.setText("Ấn CHƠI để bắt đầu");
    ...
    private void play_game() {
        ...
        if (turnPlay==1){
            Toast.makeText(context,"Bạn đánh trước", Toast.LENGTH_SHORT).show();
            playerTurn();
        }else{
            Toast.makeText(context,"Máy đánh trước", Toast.LENGTH_SHORT).show();
            botTurn();
        }
    }

    private void botTurn() {
        Log.d("GameCaro","bot turn");
        tvTurn.setText("Lượt máy");
    ...
    private void make_a_move() {
        Log.d("GameCaro","make a move with "+xMove+" ; "+yMove+" ; "+turnPlay);
        ...
        if (noEmptycell()){
            ...
            if (winner_play == 1) {
                Toast.makeText(context, "Bạn thắng rồi", Toast.LENGTH_SHORT).show();
                tvTurn.setText("Bạn thắng rồi");
            }else {
                Toast.makeText(context, "Bạn thua rồi", Toast.LENGTH_SHORT).show();
                tvTurn.setText("Bạn thua rồi");
            }
            return;
        }
    ...
    private boolean checkWinner() {
        if (winner_play!=0) return true; // !=0
        ...
        if (winner_play==0) return false; else return true; //==0
    }
    ...
    private void playerTurn() {
        Log.d("GameCaro","player turn");
        tvTurn.setText("Lượt của bạn");
        firstMove=false;
        isClicked=false;
    }
    ...
    private void designBoardGame() {
        ...
        LinearLayout.LayoutParams IpRow= new LinearLayout.LayoutParams(sizeofCell*maxN, sizeofCell);
